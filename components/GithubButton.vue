...
<template>
	<div class="display:inline-flex">
		<a v-if="type === 'stars'" href="https://github.com/stylify/packages" class="badge border-color:#fdd835!important background:$blue3 min-width:84px" rel="noopener" target="_blank">
		...
		<a v-if="type === 'sponsor'" href="https://github.com/sponsors/Machy8" class="badge border-color:#f44336!important background:$blue3" rel="noopener" target="_blank">
