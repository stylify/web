	...
	<div>
		<header>
			<div class="
				...
				minw1450px:flex-direction:row
			">
				<div class="display:flex flex-direction:column sm:flex-direction:row align-items:center margin-bottom:24px width:100% minw1450px:width:auto minw1450px:margin-bottom:0 justify-content:space-between">
					<section class="display:flex minw1450px:min-width:300px align-items:center margin-bottom:12px sm:margin-bottom:0">
					...
					<section class="display:inline-flex justify-content:flex-end min-width:150px minw1450px:display:none">
				...
				<section class="flex:1 overflow:auto width:calc(100%_+_16px) justify-content:center margin-left:-8px margin-right:-8px display:inline-flex position:relative">
					<div class="justify-content:flex-start display:flex max-width:100%">
						...
						<span class="minw1450px:display:none">&nbsp;</span>
					</div>
				</section>
				<section class="display:none minw1450px:display:inline-flex minw1450px:min-width:300px justify-content:flex-end min-width:150px">
					<LayoutHeaderSocialIcons />
				</section>
			</div>
		</header>
