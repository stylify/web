<template>
	<section itemscope itemtype="https://schema.org/FAQPage" class="container margin-bottom:48px margin-top:24px max-width:800px">
		...
		<p class="margin-bottom:24px">Bellow are frequently asked questions about Stylify CSS and it's ecosystem.</p>
		...
		<article class="[summary]{font-size:18px;font-weight:bold;color:#fff;cursor:pointer} [details]{margin-bottom:24px}">
			<faq>
				...
				<faq-answer>
					<ul>
						...
						<li>When using BEM you can end up with <div class="page-section__container page-section__container--full-size page-section__container--without-background"></div>. I can't see how property:value selectors are more bad then this.</li>
					</ul>
			...
			<faq>
				...
				<faq-answer>
					<ul>
						...
						<li>Inline styles are not responsive. You cannot ad a <code>@media query</code>. This means, you cannot have font size 12px for mobile and then change it for a desktop. Also, it is easier to toggle classes then a style attribute value.</li>
						<li>When you add a component in Stylify like <code>.button</code> that needs red text, it is generated like this <code>.color\:red,.button{color:red}</code>. The selector is simply attached, reused and the <code>property:value</code> not generated again => This means smaller bundles.</li>
						...
						<li>But the minification will make the blocks harder to find when debugging because of the unreadable classes? No. You can use empty class as selector, data or id attributes. Also, in Javascript we normally minify classes and selectors from <code>const myValue</code> to <code>const abc</code> and nobody cares.</li>
					</ul>
				</faq-answer>
			</faq>
			...
			<faq>
				...
				<faq-answer>
					<ul>
						...
						<li>The CSS size doesn't grow exponencialy, because there is a minimum of duplicated css <code>property:value</code>. There is some <a href="https://engineering.fb.com/2020/05/08/web/facebook-redesign/" target="blank" rel="noopener nofollow">article</a> about CSS size from Facebook.</li>
						...
						<li>Dynamically generated CSS means less files in the projects => less changes => we normally generate cache, entities, migrations, js bundles and etc. So Stylify dynamically generates CSS. At least from my point of view it's more comfortable and efficient then writting it manually and think about how to pregenerate utilities or combine css files manually.</li>
					</ul>
				</faq-answer>
			</faq>
			...
			<faq>
				...
				<faq-answer>
					<ul>
						...
						<li>It's just up to developer if he is going to have hardcoded values in the code or not.</li>
					</ul>
				</faq-answer>
			</faq>
			...
			<faq>
				...
				<faq-answer>
					<ul>
						...
						<li>From experience, you can bloat your templates by a lot of other stuff => conditions, attributes, dynamic attributes, dynamically loaded templates and etc. Blaming CSS selectors is simply wierd.</li>
					</ul>
				</faq-answer>
			</faq>

			<faq>
				<faq-question>Are selectors pregenerated?</faq-question>
				<faq-answer>
					<ul>
						...
						<li>Components works in the same way.</li>
				...
				<faq-answer>
					<ul>
						...
						<li>
							...
							Also the to keep things simple and united, the character must be compatible with custom selectors like <code>[&_a]{color:red}</code> where the <code>data-attribute</code> can be defined.
						</li>
					</ul>
				</faq-answer>
			</faq>
			...
			<faq>
				<faq-question>If the syntax is similar to CSS, why not to use some attribute like <code>x-style</code>?</faq-question>
				<faq-answer>
					<ul>
						...
						<li>Stylify doesnt use space for selector, because it needs the selector to be complete for further optimization like <strong>chaining a button to padding:4px_8px</strong> and <strong>mangling</strong> <code>.padding:4px_8px => .a</code></li>
					</ul>
				</faq-answer>
			</faq>
			...
			<faq>
				...
				<faq-answer>
					<ul>
						...
						<li>Stylify CSS uses CSS-like syntax and has no prearanged color palettes, sizes, random shortcuts and etc.</li>
