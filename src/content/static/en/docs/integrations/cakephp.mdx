...
<Note>Integration example for the CakePHP can be found in <a href="https://github.com/stylify/integrations-examples/tree/master/cakephp" target="_blank" rel="noopener">integrations examples repository</a>.</Note>
...
Install the [@stylify/bundler](/en/docs/bundler) package using NPM or Yarn:
