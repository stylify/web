...
- Custom selectors can be now generated directly from template. See [docs](/en/docs/stylify/compiler#customselectors).
...
```
- Hooks are now used like below. Check out [Stylify hooks](/en/docs/stylify/compiler#hooks).
```javascript
...
### @stylify/bundler
- Bundler hooks are now used like below. Bundler hooks extends the default Stylify CSS hooks. Check out [Bundler hooks](/en/docs/bundler#hooks).
```javascript
