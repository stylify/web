...
3. [bundler:fileToProcessOpened](/en/docs/bundler#hooks) hook is added. This hook has two parts. One part is done, when this file is a layout or page and the another for every opened file.
