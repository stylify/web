...
Exactly because of the reasons above, [stylifycss.com](/) have been created.
...
The CSS selectors can also be minified [when used in node.js](/en/docs/stylify/compiler#usage):
...
In case you also take the time and separate your CSS for layout and each page separately ([which is easy to do with Stylify](/en/docs/bundler#installation)) you can have a really small CSS chunk for each of your pages.
