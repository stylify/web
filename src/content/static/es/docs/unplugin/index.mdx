...
const config = defineConfig({
	...
	// Id es un nombre de archivo
	// Devuelve true, si el tipo o nombre de archivo debe ser procesado
	// El ejemplo es con sufijo HTML
	// Por defecto Stylify CSS comprueba si el archivo no está en node_modules
	// y también comprueba si hay varios tipos de archivos
	// listados aquí https://github.com/stylify/packages/blob/master/packages/unplugin/src/index.ts
